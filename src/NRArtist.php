...
class NRArtist {
    ...
    public function register($args) {
        ...
        if(isset($profile_photo)) {
            ...
            "INSERT INTO nr_artists(username, email, password, bio, instagram, facebook, twitter, role_id, locked, probation, profile_photo)
                VALUES(\"$username\", \"$email\", \"$password\", \"$bio\", \"$instagram\", \"$facebook\", \"$twitter\", $role, 1, 0, \"$profile_photo\");";
        } else {
            $sql =
            "INSERT INTO nr_artists(username, email, password, bio, instagram, facebook, twitter, role_id, locked, probation, profile_photo)
                VALUES(\"$username\", \"$email\", \"$password\", \"$bio\", \"$instagram\", \"$facebook\", \"$twitter\", $role, 1, 0, \"https://glamsquad.sgp1.cdn.digitaloceanspaces.com/GlamSquad/default/images/profile.svg\");";
        }
    ...
    function sendNewRegEmail($id, $email, $username, $country) {
        ...
        $args = [
            ...
            "from_name" => "NygmaRose",
            "subject" => "[GlamSquad] New Artist Registration",
            "body" =>
                "<html>
                    <head>
                        <style>
                    ...
                    <body>
                        <p>
                            New Artist $username <$email> has registeerd with ID $id.
                            <br><br>
                            Registration Country:<br>
                            $country.
                            <br><br>
                            <small>Email automatically generated by GlamSquad server.</small>
                        </p>
                    </body>
                </html>"
        ];
